...
# from core.model_test import TwoStreamAUAttentionModelTest, TwoStreamFusionTDNNTest,TwoStreamFusionAUAttentionModel,TwoStreamAUAttentionModelTest
...
class Inference():
    def __init__(self, output_exp_name, model_path,start):
        ...
        self.model = TwoStreamAUAttentionModelTest(seq_num=30, encoder_layers=1)
    ...
    def inference_au_batch(self):
        ...
        for video in tqdm(au_test_video_list):
            ...
            for data,ids in iter(test_loader):
                # print("%%%%%%%%%%%")
...
if __name__ == '__main__':
    start = 15
    # output_exp_name = 'au_video-seq-fps_0.7105-start15'
    ...
    # model_path = ''
    output_exp_name = 'au_video-seq-fps_0.7120-start0'
    model_path = '/data/tian/developer/output/pytorch_au/2.5.1_se50_lr0.001_pos0_dataset5_64/save/score_0.7315276637883353_optimizer_2021-07-08-08-47_acc:0.8956518948725117_f1:0.5674034327041589_bacth:3_step:0.pth'    
