...
from Learner import EmotionLearner
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='iresnet100', help='network name')
    ...
    parser.add_argument('--expr_train_annot_path', type=str, default='', help='train_annot_path')
    ...
    conf.expr_train_annot_path = args.expr_train_annot_path
